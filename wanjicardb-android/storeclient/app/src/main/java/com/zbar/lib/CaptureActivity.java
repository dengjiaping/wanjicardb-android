 ...
 * 
 * 描述: 扫描界面
 * 注意：theme要使用android:theme="@style/Theme.AppCompat.Light.NoActionBar"
 */
public class CaptureActivity extends BaseActivity implements Callback {
	...
	public void handleDecode(String result) {
		...
		if (!TextUtils.isEmpty(result) && 18 == result.length() && result.startsWith("86")){
			setResult(RESULT_OK, new Intent().putExtra(SCAN_RESULT, result));
			finish();
		}else {
			Toast.makeText(this, "无效付款码，请出示万集卡付款码", Toast.LENGTH_SHORT).show();
